...
const productColor = (product) => {
  let color = ""
  for(let proc of product.product.processes){
    if(proc.process_list.name == "Welding"){
      color = "text-purple-500"
    }else if(proc.process_list.name == "Laser"){
      color = "text-blue-500"
    }else if(proc.process_list.name == "Tube Laser"){
...
<template>
    <AdminLayout>
        ...
        <vue3-datatable
            ...
            @rowClick="setRow"
        >
            <template #product.drawing_nr="data">
              <div :class="productColor(data.value)">
                {{ data.value.product.drawing_nr }}
              </div>
            </template>
                ...
                <SelectContent>
                  <SelectGroup>
                    <SelectLabel>Status</SelectLabel>
                      ...
                      <SelectItem value="Invoice needed">
                        Invoice needed
                      </SelectItem>
        ...
        <Drawer v-model:open="sheetOpen">
          <DrawerContent class="h-250">
            ...
            <div class="flex justify-center items-center w-full">
              <div class="p-4 w-250">
                <h1 class="text-xl mb-5">Plan nr. {{ sheetRow.po_nr }}, Product {{ sheetRow.product.drawing_nr }}</h1>
