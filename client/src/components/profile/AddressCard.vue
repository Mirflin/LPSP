        ...
        <div>
          ...
          <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            <div>
              ...
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ auth.profile.country }}</p>
            </div>
            ...
            <div>
              ...
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ auth.profile.postal_code }}</p>
            </div>
          </div>
        </div>
      </div>
